...
public class NuerScenery : IScenery
{
    private static Mesh cubeMesh;
    private static int stuffPerRow = 24;
    ...
    private static GameObject GeneratePillarSlice(int sliceIndex)
    {
        ...
        go.transform.localPosition = new Vector3(sliceIndex * 24 - (stuffPerRow / 2 * 24), -30, 0) + UnityEngine.Random.insideUnitSphere * 10;
